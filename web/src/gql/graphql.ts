...
export type Query = {
  ...
  getUserMealsGroupedCountAdmin?: Maybe<Array<UserMealAdminOutput>>;
...
export type UserMealAdminInput = {
  dateFrom: Scalars['String']['input'];
  dateTo: Scalars['String']['input'];
  mealBoardPlanId: Scalars['Int']['input'];
};

export type UserMealAdminOutput = {
