...
export type Query = {
  ...
  getUserMealsGroupedCountAdmin?: Maybe<Array<UserMealUserOutput>>;
...
export type UserMealLocationUser_Meal_Location_UserId_TimeOfDay_UniqueCompoundUniqueInput = {
  timeOfDay: TimeOfDay;
  userId: Scalars['Int']['input'];
};
...
export type UserMealUserInput = {
  dateFrom: Scalars['String']['input'];
  dateTo: Scalars['String']['input'];
  mealBoardPlanId: Scalars['Int']['input'];
};

export type UserMealUserOutput = {
